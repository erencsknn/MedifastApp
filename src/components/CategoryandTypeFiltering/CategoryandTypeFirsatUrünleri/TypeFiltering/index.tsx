...
function index() {
    ...
    return(
        <ScrollView style={{width:'100%',backgroundColor:'white',height:height*0.080,flexDirection:'row',paddingVertical:height*0.014,paddingHorizontal:12,borderBottomColor : 'lightgrey', borderBottomWidth:2}} showsHorizontalScrollIndicator={false} bounces={true} horizontal={true}>
            {["Ağrı Kesici","Alerji","Damlalar","Soğuk Algınlığı",].map((item)=>(
