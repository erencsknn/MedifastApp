...
function index({item}: categoryItemProps) {
  ...
  return (
    <TouchableOpacity onPress={() => navigation.navigate("CategoryDetailsIlaclar",{category:item})} style={{width:width*0.20,height:width*0.25,flexDirection:'column',alignItems:'center',justifyContent:'space-between',marginTop:10}}>
